...
import {Avatar, Flex, Spacer, Image, Text} from "@chakra-ui/react";
            ...
            <Block backgroundColor="Marionum.50" paddingY="30px">
                <Flex alignItems="center">
                    ...
                    <Flex alignItems="center" shrink={0} gap="16px">
                        <NotificationIcon boxSize="24px" notify/>
                        <Avatar src='https://bit.ly/sage-adebayo'/>
                    </Flex>
                </Flex>
            </Block>
            <Block backgroundColor="Marionum.200" paddingY="30px">Test 1 <Flex alignItems="center"
                                                                               gap="16px"><NotificationIcon
                boxSize="24px"/> <Avatar src='https://bit.ly/sage-adebayo'/></Flex></Block>
            <Block backgroundColor="Marionum.700" paddingY="30px">Test 1</Block>
